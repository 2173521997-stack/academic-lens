...
export function createBrowserBridge(): Bridge {
  ...
  return {
    ...
    shortcutGetStatus: async () => ({ toggle: true, mode: true, selection: true, selectionAccel: 'Ctrl+Shift+X', registeredAccels: ['Ctrl+Shift+X'], occupied: [] }),
    shortcutAccel: async () => 'Ctrl+Shift+X',
    selectionTest: async () => ({ text: null, error: '浏览器模式不支持全局取词', accel: 'Ctrl+Shift+X' }),
    shortcutRetry: async () => ({ toggle: true, mode: true, selection: true, selectionAccel: 'Ctrl+Shift+X', registeredAccels: ['Ctrl+Shift+X'], occupied: [] }),
