...
export interface Bridge {
  ...
  shortcutGetStatus: () => Promise<{ toggle: boolean; mode: boolean; selection: boolean; selectionAccel?: string; registeredAccels?: string[]; occupied?: string[] }>
  shortcutAccel: () => Promise<string>
  selectionTest: () => Promise<{ text: string | null; error: string | null; accel: string }>
  shortcutRetry: () => Promise<{ toggle: boolean; mode: boolean; selection: boolean; selectionAccel?: string; registeredAccels?: string[]; occupied?: string[] }>
  onShortcutStatus: (cb: (s: { toggle: boolean; mode: boolean; selection: boolean; selectionAccel?: string; registeredAccels?: string[]; occupied?: string[] }) => void) => () => void
